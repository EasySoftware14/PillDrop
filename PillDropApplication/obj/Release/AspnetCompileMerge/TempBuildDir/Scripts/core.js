...
$(document).ready(function () {
    ...
    //    var tableSelector = stringFormat("table#{0}", moduleId);
    //    if ($(this).is(':checked')) {
    //        $(tableSelector).find(':checkbox').prop('checked', true);
    //        $(tableSelector).find('tr').addClass('row_selected');
    //        //$(this).parent().parent().parent().toggleClass('row_selected');	
    //    } else {
    //        $(tableSelector).find(':checkbox').prop('checked', false);
    //        $(tableSelector).find('tr').removeClass('row_selected');
