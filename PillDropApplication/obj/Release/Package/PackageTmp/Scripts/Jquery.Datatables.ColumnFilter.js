...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateDateRangeInput(oTable) {
            ...
            //th.html(_fnRangeLabelPart(0));
            var sFromId = oTable.attr("id") + '_range_from_' + i;
            var from = $('<div class="input-append success date no-padding" style="display: inline-flex;"><input type="text" class="date_range_filter form-control" id="' + sFromId + '" rel="' + i + '" placeholder="Start Date"/><span class="add-on"><span class="arrow"></span><i class="fa fa-th"></i></span></div>');
            from.datepicker();
            //th.append(from);
            //th.append(_fnRangeLabelPart(1));
            var sToId = oTable.attr("id") + '_range_to_' + i;
            var to = $('<div class="input-append success date no-padding" style="display: inline-flex;"><input type="text" class="date_range_filter form-control" id="' + sToId + '" rel="' + i + '" placeholder="End Date"/><span class="add-on"><span class="arrow"></span><i class="fa fa-th"></i></span></div>');
            //th.append(to);
            //th.append(_fnRangeLabelPart(2));
